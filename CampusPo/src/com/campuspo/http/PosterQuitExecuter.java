...
public class PosterQuitExecuter extends HttpExecuter {
	
	private static final String TAG = PosterQuitExecuter.class.getSimpleName();
	
	private static final Method mMethodType = Method.GET;
	private static final String PATH = "/quit";
	
	private HashMap<String, String> mParams;
	
	

	public PosterQuitExecuter(HashMap<String, String> params) {
		mParams = params;
	}
