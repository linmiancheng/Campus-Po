...
public class GetParticipantExecuter extends HttpExecuter{
	
	private static final String TAG = JoinExecuter.class.getSimpleName();

	private static final String PATH = "/getParticipantList";

	private static final Method mMethodType = Method.GET;

	private HashMap<String, String> mParams;

	public GetParticipantExecuter(HashMap<String, String> params) {
		mParams = params;
	}
